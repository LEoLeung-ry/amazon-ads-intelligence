...
5. Verify:
   ...
   - After exporting the confirmed package, the workflow compass, `Next action`, execution package, and receipt all show an exported/execution-ready state. They should say `重新导出已确认` rather than continuing to prompt the first export.
